...
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
#  Make plots of long-term scores using monthly values for all international models.
#  Include unsmoothed and smoothed lines on the same plots.
#  Fanglin Yang, Dec 2007
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
export sorcdir=${sorcdir:-/global/save/Fanglin.Yang/vrfygfs/longterm/legacy}
export sdate=${sdate:-01jan1996}
export edate=${edate:-28feb2008}
export sdat1=${sdat1:-01mar2007}                 ;#for computing last year average
...
export HGTplot="YES"
export WINDplot="YES"
export ftpdir=${ftpdir:-/home/people/emc/www/htdocs/gmb/STATS_vsdb/allmodel/longall}
export doftp=${doftp:-"NO"}        ;#ftp daily maps to web site

export mdlist="GFS ECM UKM FNO CMC CDAS"                 ;#models for line plots
export mdlist2d="GFS ECM FNO CDAS"                   ;#models for 2D map plots
...
export smth=${smth:-12}                           ;#number of months used for computing running mean
export xlon2d=11                                 ;#forecast days+1 to show on 2D and dieoff maps 


export datadir=${sorcdir}/monthly
export rundir=/stmp/$LOGNAME/legacy
...
* cma.1=0; cma.2=8; cma.3=6; cma.4=1; cma.5=2; cma.6=0; cma.7=3; cma.8=7
  ...
  cth.1=9; cth.2=9; cth.3=9; cth.4=9; cth.5=9; cth.6=9; cth.7=9; cth.8=9
  ...
  'set time $sdate $edate' 
   ...
   while (i <= $nmd)
    ...
    'define varm'%i'=ave(ac${wav}.'%i',t-${smth2},t+${smth2})'
   i=i+1
   endwhile
...
*  while (i <= $nmd)
   ...
   while (i <= $nmd)
    ...
    if ( b>0 )
      ...
      'set cstyle 'cst.i; 'set cthick 1'; 'set cmark 'cma.i; 'set ccolor 'cco.i
...
*     'set xlint $xtick'
  ...
  'draw string 'titlx' 'titly' ${area} HGT AC: ${lev}hPa Wave${wave} Day${day}, ${smth}-Mon Mean'
...
*   if(i>1);'d var'%i' - var1' ;endif
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  HGT AC: ${area} ${lev}hPa Wave${wave}, ${smth}-Mon Mean'   
  'set string 1 bc 5'
...
*
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  Annual Mean HGT AC: ${area} ${lev}hPa Wave${wave}'   
  'set string 1 bc 5'
  'set strsiz 0.13 0.13'
  'set strsiz 0.15 0.15'
  if($nmd2d >1)
...
* cma.1=0; cma.2=8; cma.3=6; cma.4=1; cma.5=2; cma.6=0; cma.7=3; cma.8=7
  ...
  'set time $sdate $edate' 
   ...
   while (i <= $nmd)
    ...
    'define varm'%i'=ave(${vname}.'%i',t-${smth2},t+${smth2})'
   i=i+1
   endwhile
