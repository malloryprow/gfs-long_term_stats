...
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
#  Make plots of long-term scores of GFS, all 4 cycles
#  Show differences of other cycles to the 00Z cycle on the bottom of line plots
#  Fanglin Yang, Dec 2009
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
export sorcdir=${sorcdir:-/global/save/Fanglin.Yang/vrfygfs/longterm/legacy}
export sdate=01nov2002
#export sdate=01may2002
#export sdate=01jan1996
export edate=${edate:-30may2013}
export sdat1=${sdat1:-01may2012}                 ;#for computing last year average
export cyclist=${cyclist:-"00Z 06Z 12Z 18Z"}                 ;#forecast cycle
...
export HGTplot="YES"
export WINDplot="YES"
export ftpdir=${ftpdir:-/home/people/emc/www/htdocs/gmb/STATS_vsdb/longterm/longgfs4cyc}
export doftp=${doftp:-"YEs"}        ;#ftp daily maps to web site

export mdlist="GFS"                 ;#models for line plots
export mdlist2d="GFS"               ;#models for 2D map plots

export fdays=${fdays:-"1 2 3 4 5 6 7 8"}         ;#forecast day
export waves=${waves:-"13 49 1020 120"}          ;#wave numbers for anomaly correlations
...
export rundir=/stmp/$LOGNAME/legacy_gfs4cyc
...
for cyc in $cyclist; do
  k=`expr $k + 1 `
  export ctlHGT${k}=${datadir}/HGT${mdls}${cyc}_month.ctl
  export ctlWIND${k}=${datadir}/WIND${mdls}${cyc}_month.ctl
done
##export nmd=`echo $mdlist | wc -w`          ;#count number of models 
##set -A mdname none $mdlist
export nmd=`echo $cyclist | wc -w`          ;#count number of cycles
set -A mdname none $cyclist
...
for cyc in $cyclist; do
  k=`expr $k + 1 `
  export ctl2dHGT${k}=${datadir}/HGT${mdls}${cyc}_month.ctl
  export ctl2dWIND${k}=${datadir}/WIND${mdls}${cyc}_month.ctl
done
##export nmd2d=`echo $mdlist2d | wc -w`        ;#count number of models on 2D and dieoff maps
##set -A mdname2d none $mdlist2d
export nmd2d=`echo $cyclist | wc -w`          ;#count number of cycles on 2D and dieoff maps
set -A mdname2d none $cyclist
...
for area in NH SH; do
 if [ $area = "NH" ]; then ylat=1 ; fi
 if [ $area = "SH" ]; then ylat=2 ; fi
for lev in $levsz; do
#-----------------------------------------------------------------------
...
if($nmd >1); 'open ${ctlHGT2}'; mdc.2=${mdname[2]} ;endif
if($nmd >2); 'open ${ctlHGT3}'; mdc.3=${mdname[3]} ;endif
if($nmd >3); 'open ${ctlHGT4}'; mdc.4=${mdname[4]} ;endif
if($nmd >4); 'open ${ctlHGT5}'; mdc.5=${mdname[5]} ;endif
if($nmd >5); 'open ${ctlHGT6}'; mdc.6=${mdname[6]} ;endif
if($nmd >6); 'open ${ctlHGT7}'; mdc.7=${mdname[7]} ;endif
if($nmd >7); 'open ${ctlHGT8}'; mdc.8=${mdname[8]} ;endif
...
*     'set xlint $xtick'
  ...
  'draw string 'titlx' 'titly' $model ${area} HGT AC: ${lev}hPa Wave${wave} Day${day}, ${smth}-Mon Mean'
  'set string 1 bl 3'
...
if($nmd2d >1); 'open ${ctl2dHGT2}'; mdc.2=${mdname2d[2]} ;endif
if($nmd2d >2); 'open ${ctl2dHGT3}'; mdc.3=${mdname2d[3]} ;endif
if($nmd2d >3); 'open ${ctl2dHGT4}'; mdc.4=${mdname2d[4]} ;endif
if($nmd2d >4); 'open ${ctl2dHGT5}'; mdc.5=${mdname2d[5]} ;endif
if($nmd2d >5); 'open ${ctl2dHGT6}'; mdc.6=${mdname2d[6]} ;endif
if($nmd2d >6); 'open ${ctl2dHGT7}'; mdc.7=${mdname2d[7]} ;endif
if($nmd2d >7); 'open ${ctl2dHGT8}'; mdc.8=${mdname2d[8]} ;endif
...
*   if(i>1);'d var'%i' - var1' ;endif
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model HGT AC: ${area} ${lev}hPa Wave${wave}, ${smth}-Mon Mean'   
  'set string 1 bc 5'
...
*     'set strsiz 0.12 0.12'; yt=yt+0.2
...
**draw one index for all panels instead of one on each panel
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model Annual Mean HGT AC: ${area} ${lev}hPa Wave${wave}'   
  'set string 1 bc 5'
  'set strsiz 0.13 0.13'
  'set strsiz 0.15 0.15'
  if($nmd2d >1)
  ...
  'printim acz_wave${wav}_${area}${lev}mb_dieoff.png png x700 y700'
  'set vpage off'
'quit'
EOF1
...
for vname in zrms zerr; do
 if [ $vname = "zrms" ]; then export des="RMSE" ; fi
 if [ $vname = "zerr" ]; then export des="Bias" ; fi
#...................................
...
*     'set xlint $xtick'
  ...
  'set string 1 bc 7'
  'set strsiz 0.16 0.16'
  'draw string 'titlx' 'titly' $model ${area} HGT ${des}: ${lev}hPa Day${day}, ${smth}-Mon Mean'
  'set string 1 bl 3'
  'set strsiz 0.09 0.09'
...
*   if(i>1);'d var'%i '- var1 ';endif
  ...
  'set string 1 bc 6'
  'set strsiz 0.14 0.14'
  'draw string 4.5 10.35  $model ${area} ${lev}hPa HGT ${des}, ${smth}-Mon Mean'
  'set string 1 bc 4'
  'set strsiz 0.14 0.14'
  'set strsiz 0.15 0.15'
  if($nmd2d >2)
...
**draw one index for all panels instead of one on each panel
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model Annual Mean HGT ${des}: ${area} ${lev}hPa '
  'set string 1 bc 5'
  'set strsiz 0.13 0.13'
  'set strsiz 0.15 0.15'
  if($nmd2d >1)
  ...
  'printim ${vname}_${area}${lev}mb_dieoff.png png x700 y700'
  'set vpage off'
'quit'
EOF1
...
for vname in urms vrms srms wrms uerr verr serr werr; do
 ...
 if [ $vname = "wrms" ]; then export des="Vector Wind RMSE" ; fi
 if [ $vname = "uerr" ]; then export des="U Wind Bias" ; fi
 if [ $vname = "verr" ]; then export des="V Wind Bias" ; fi
 if [ $vname = "serr" ]; then export des="Wind Speed Bias" ; fi
...
if($nmd >1); 'open ${ctlWIND2}'; mdc.2=${mdname[2]} ;endif
if($nmd >2); 'open ${ctlWIND3}'; mdc.3=${mdname[3]} ;endif
if($nmd >3); 'open ${ctlWIND4}'; mdc.4=${mdname[4]} ;endif
if($nmd >4); 'open ${ctlWIND5}'; mdc.5=${mdname[5]} ;endif
if($nmd >5); 'open ${ctlWIND6}'; mdc.6=${mdname[6]} ;endif
if($nmd >6); 'open ${ctlWIND7}'; mdc.7=${mdname[7]} ;endif
if($nmd >7); 'open ${ctlWIND8}'; mdc.8=${mdname[8]} ;endif
...
*     'set xlint $xtick'
  ...
  'set string 1 bc 7'
  'set strsiz 0.14 0.14'
  'draw string 'titlx' 'titly' $model Tropic ${des}: ${lev}hPa Day${day}, ${smth}-Mon Mean'
  'set string 1 bl 3'
  'set strsiz 0.09 0.09'
...
if($nmd2d >1); 'open ${ctl2dWIND2}'; mdc.2=${mdname2d[2]} ;endif
if($nmd2d >2); 'open ${ctl2dWIND3}'; mdc.3=${mdname2d[3]} ;endif
if($nmd2d >3); 'open ${ctl2dWIND4}'; mdc.4=${mdname2d[4]} ;endif
if($nmd2d >4); 'open ${ctl2dWIND5}'; mdc.5=${mdname2d[5]} ;endif
if($nmd2d >5); 'open ${ctl2dWIND6}'; mdc.6=${mdname2d[6]} ;endif
if($nmd2d >6); 'open ${ctl2dWIND7}'; mdc.7=${mdname2d[7]} ;endif
if($nmd2d >7); 'open ${ctl2dWIND8}'; mdc.8=${mdname2d[8]} ;endif
...
*   if(i>1);'d var'%i '- var1 ';endif
  ...
  'set string 1 bc 6'
  'set strsiz 0.14 0.14'
  'draw string 4.5 10.35  $model Tropic ${lev}hPa ${des}, ${smth}-Mon Mean'
  'set string 1 bc 4'
  'set strsiz 0.14 0.14'
  'set strsiz 0.15 0.15'
  if($nmd2d >2)
...
**draw one index for all panels instead of one on each panel
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model Annual Mean Tropical ${lev}hPa ${des}'
  'set string 1 bc 5'
  'set strsiz 0.13 0.13'
  'set strsiz 0.15 0.15'
  if($nmd2d >1)
  ...
  'printim ${vname}_${lev}mb_dieoff.png png x700 y700'
  'set vpage off'
'quit'
EOF1
