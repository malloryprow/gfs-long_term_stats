...
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
#  Make plots of long-term scores using monthly values
#  Show differences of other centers to the first one on the bottom of line plots
#  Fanglin Yang, Dec 2007
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
export sorcdir=${sorcdir:-/global/save/Fanglin.Yang/vrfygfs/longterm/legacy}
export sdate=${sdate:-01jan1996}
export edate=${edate:-31mar2012}
export sdat1=${sdat1:-01apr2011}                 ;#for computing last year average
...
export HGTplot="YES"
export WINDplot="YES"
export ftpdir=${ftpdir:-/home/people/emc/www/htdocs/gmb/STATS_vsdb/longterm/longall}
...
*     'set strsiz 0.10 0.10'; yt=yt+0.18
