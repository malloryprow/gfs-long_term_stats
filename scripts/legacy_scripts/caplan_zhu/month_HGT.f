      ...
      integer, parameter :: nd=366, nh=2, nz=2,nf=17
      integer, parameter :: nvar=8, nm=12               
!--daily stats  
!     real*4 :: ac13(nf,nh,nz,nd), ac49(nf,nh,nz,nd) 
!     real*4 :: ac1020(nf,nh,nz,nd), ac120(nf,nh,nz,nd) 
!     real*4 :: zrms(nf,nh,nz,nd), zerr(nf,nh,nz,nd) 
!     real*4 :: zrmsc(nf,nh,nz,nd), zerrc(nf,nh,nz,nd) 
      real*4 :: varday(nf,nh,nz,nd,nvar)
!--monthly means
!     real*4 :: ac13m(nf,nh,nz,nm), ac49m(nf,nh,nz,nm) 
!     real*4 :: ac1020m(nf,nh,nz,nm), ac120m(nf,nh,nz,nm) 
!     real*4 :: zrmsm(nf,nh,nz,nm), zerrm(nf,nh,nz,nm) 
!     real*4 :: zrmscm(nf,nh,nz,nm), zerrcm(nf,nh,nz,nm) 
...
!--
      ...
      data vname/"HGT AC Wave1-3    ", "HGT AC Wave4-9    ","HGT AC Wave10-20  ","HGT AC Wave1-20   ",&
                 "HGT RMSE          ", "HGT Error         ","HGT RMSEC         ","HGT ERRORC        "/
      data lev/"1000 hpa", "500 hpa "/
      data hemis/"NH      ", "SH      "/
      integer :: mday(nm)
      ...
      open(10,file="HGTs18Z_month.bin",form="unformatted",status="unknown")
      open(20,file="HGTs18Z_mean.txt",form="formatted",status="unknown")
      ...
      infile="/global/save/Fanglin.Yang/vrfygfs/vsdb_data/legacy/daily/HGTs18Z_"//yc//".bin"
      print*,infile        
