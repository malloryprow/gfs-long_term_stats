...
export sdate=01jan2003    
export edate=${edate:-31dec2014}
export sdat1=${sdat1:-01jan2014}                 ;#for computing last year average
...
export rundir=${execdir:-/stmpd2/$LOGNAME/longterm}/gfs4cyc
...
**old
  ...
  'draw string 'titlx' 'titly' $model ${area} HGT AC: ${lev}hPa Day${day}, ${smth}-Mon Mean'
  'set string 1 bl 3'
...
**new stats
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model HGT AC: ${area} ${lev}hPa, ${smth}-Mon Mean'   
  'set string 1 bc 5'
...
**draw one index for all panels instead of one on each panel
  ...
  'set string 1 bc 6'
  'set strsiz 0.15 0.15'
  'draw string 4.2 10.4  $model Annual Mean HGT AC: ${area} ${lev}hPa '   
  'set string 1 bc 5'
  'set strsiz 0.13 0.13'
  'set strsiz 0.15 0.15'
  if($nmd2d >1)
