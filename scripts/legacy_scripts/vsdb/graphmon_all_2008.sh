...
# 2. Use only VSDB-based verification stats (2008 onward). 
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
...
#export sdate=${sdate:-01jan2008}
export sdate=01jan2010
export edate=${edate:-31dec2019}
export sdat1=${sdat1:-01jan2019}                 ;#for computing last year average
...
export mdlist="GFS ECM UKM CMC FNO CFSR"             ;#models for line plots
export mdlist2d="GFS ECM UKM CMC FNO CFSR"           ;#models for 2D map plots
...
export rundir=${execdir:-/stmpd2/$LOGNAME/longterm}/monall
...
for area in NH SH; do
 if [ $area = "NH" ]; then  ylatx=2; fi
 if [ $area = "SH" ]; then  ylatx=3; fi
for lev in $levsz; do
#-----------------------------------------------------------------------
...
'reinit'; 'set font 1'
             'open ${ctlxHGT1}'; mdc.1=${mdname[1]}
if($nmd >1); 'open ${ctlxHGT2}'; mdc.2=${mdname[2]} ;endif
if($nmd >2); 'open ${ctlxHGT3}'; mdc.3=${mdname[3]} ;endif
if($nmd >3); 'open ${ctlxHGT4}'; mdc.4=${mdname[4]} ;endif
if($nmd >4); 'open ${ctlxHGT5}'; mdc.5=${mdname[5]} ;endif
if($nmd >5); 'open ${ctlxHGT6}'; mdc.6=${mdname[6]} ;endif
if($nmd >6); 'open ${ctlxHGT7}'; mdc.7=${mdname[7]} ;endif
if($nmd >7); 'open ${ctlxHGT8}'; mdc.8=${mdname[8]} ;endif
...
* cma.1=0; cma.2=8; cma.3=6; cma.4=1; cma.5=2; cma.6=0; cma.7=3; cma.8=7
  ...
  'set time $sdate $edate' 
   ...
   i=1
   while (i <= $nmd)
    'define varx'%i'=ave(cor.'%i'(y=${ylatx}),t-${smth2},t+${smth2})'
   i=i+1
   endwhile
...
'set display color white'
              'open ${ctl2dxHGT1}'; mdc.1=${mdname2d[1]}
if($nmd >1);  'open ${ctl2dxHGT2}'; mdc.2=${mdname2d[2]} ;endif
if($nmd >2);  'open ${ctl2dxHGT3}'; mdc.3=${mdname2d[3]} ;endif
if($nmd >3);  'open ${ctl2dxHGT4}'; mdc.4=${mdname2d[4]} ;endif
if($nmd >4);  'open ${ctl2dxHGT5}'; mdc.5=${mdname2d[5]} ;endif
if($nmd >5);  'open ${ctl2dxHGT6}'; mdc.6=${mdname2d[6]} ;endif
if($nmd >6);  'open ${ctl2dxHGT7}'; mdc.7=${mdname2d[7]} ;endif
if($nmd >7);  'open ${ctl2dxHGT8}'; mdc.8=${mdname2d[8]} ;endif
  ...
  while ( i <= nframe )
    ...
    'set ylopts 1 4 0.0'
     ...
     if ( b>10 )
      ...
      'set vrange 0.3 1'; 'set ylint  0.1 '
...
* cma.1=0; cma.2=8; cma.3=6; cma.4=1; cma.5=2; cma.6=0; cma.7=3; cma.8=7
  ...
  'set time $sdate $edate' 
   ...
   i=1
   while (i <= $nmd)
    'define varx'%i'=ave(${vnamex}.'%i'(y=${ylatx}),t-${smth2},t+${smth2})'
   i=i+1
   endwhile
...
if($nmd >7);  'open ${ctl2dxHGT8}'; mdc.8=${mdname2d[8]} ;endif
  ...
  'set time $sdate $edate' 
   ...
   i=1
   while (i <= $nmd2d)
    'define varx'%i'=${vnamex}.'%i'(y=${ylatx})'
   i=i+1
   endwhile
...
'reinit'; 'set font 1'
              'open ${ctlxWIND1}'; mdc.1=${mdname[1]}
if($nmd >1);  'open ${ctlxWIND2}'; mdc.2=${mdname[2]} ;endif
if($nmd >2);  'open ${ctlxWIND3}'; mdc.3=${mdname[3]} ;endif
if($nmd >3);  'open ${ctlxWIND4}'; mdc.4=${mdname[4]} ;endif
if($nmd >4);  'open ${ctlxWIND5}'; mdc.5=${mdname[5]} ;endif
if($nmd >5);  'open ${ctlxWIND6}'; mdc.6=${mdname[6]} ;endif
if($nmd >6);  'open ${ctlxWIND7}'; mdc.7=${mdname[7]} ;endif
if($nmd >7);  'open ${ctlxWIND8}'; mdc.8=${mdname[8]} ;endif
...
'reinit'; 'set font 1'
'set display color white'
              'open ${ctl2dxWIND1}'; mdc.1=${mdname2d[1]}
if($nmd >1);  'open ${ctl2dxWIND2}'; mdc.2=${mdname2d[2]} ;endif
if($nmd >2);  'open ${ctl2dxWIND3}'; mdc.3=${mdname2d[3]} ;endif
if($nmd >3);  'open ${ctl2dxWIND4}'; mdc.4=${mdname2d[4]} ;endif
if($nmd >4);  'open ${ctl2dxWIND5}'; mdc.5=${mdname2d[5]} ;endif
if($nmd >5);  'open ${ctl2dxWIND6}'; mdc.6=${mdname2d[6]} ;endif
if($nmd >6);  'open ${ctl2dxWIND7}'; mdc.7=${mdname2d[7]} ;endif
if($nmd >7);  'open ${ctl2dxWIND8}'; mdc.8=${mdname2d[8]} ;endif
...
EOF
 ...
 sub -a GFS-MTN -q transfer -g g01 -p 1/1/S -t 0:30:00 -r 64/1 $rundir/ftpcard.sh
fi
#-------------
fi
#-----------------------------------------------
