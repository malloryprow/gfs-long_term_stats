...
# 3. for the last five years; using only new vsdb-based stats
#---------------------------------------------------------------------------------------------------
#---------------------------------------------------------------------------------------------------
...
export mdlist="GFS ECM UKM FNO CMC"             ;#models for line plots
#export mdlist="ECM GFS"                                   ;#models for line plots
export mdlist2d="GFS ECM UKM FNO CMC"           ;#models for 2D map plots
...
* cma.1=0; cma.2=8; cma.3=6; cma.4=1; cma.5=2; cma.6=0; cma.7=3; cma.8=7
  ...
  cma.1=0; cma.2=8; cma.3=2; cma.4=6; cma.5=1; cma.6=7; cma.7=0; cma.8=0
  cco.1=1; cco.2=2; cco.3=4; cco.4=15; cco.5=9; cco.6=3; cco.7=5; cco.8=6
