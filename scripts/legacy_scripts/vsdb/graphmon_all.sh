...
export edate=${edate:-30jun2016}
export sdat1=${sdat1:-01jul2015}                 ;#for computing last year average
...
export rundir=${execdir:-/gpfs/dell6/ptmp/$USER/longterm}/monall
...
**old
  ...
  if ( a>0 )
     ...
     'set xlopts 1 6 0.14'
     'set ylopts 1 6 0.14'; 'set clopts 1 6 0.0'
     'set vrange 'cmin' 'cmax; 'set ylint 'cintp; 'set xlint 24'
     'set cstyle 'cst.i; 'set cthick 'cth.i; 'set cmark 'cma.i; 'set ccolor 'cco.i
...
EOF
 ...
 sub -a GFS-DEV -q transfer -g g01 -p 1/1/S -t 0:30:00 -r 64/1 $rundir/ftpcard.sh
fi
#-------------
fi
#-----------------------------------------------
